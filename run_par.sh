...
if output2=$(./build/bin/starplat-opt --starplat-to-llvm ./testing/bd.mlir -o ./testing/lowered_bd.mlir 2>&1); then
...
if output4=$(clang++ -fopenmp ./testing/llvm_bd.ll ./testing/main.cpp -o ./testing/a.out 2>&1); then
